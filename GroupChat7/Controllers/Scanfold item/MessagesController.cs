...
namespace GroupChat7.Controllers
{
    public class MessagesController : Controller
    {
        ...
        public MessagesController(GroupChatContext context)
        {
            _context = context;
        }
        ...
        {
            var groupChatContext = _context.Message.Include(m => m.Group).Include(m => m.User);
            return View(await groupChatContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'GroupChatContext.Message'  is null.");
            }
            var message = await _context.Message.FindAsync(id);
            if (message != null)
            {
